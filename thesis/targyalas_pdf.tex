...
\todo[inline]{A példamondat begenerálása úgy van megoldva, hogy az aktuálisan mutattott szövegrészt veszi alapul. Ez nem feltételnül egy teljes mondat. Ez így picit béna. Ha van időd akkor fixáld ezt  úgy, hogy tényleg egy kerek mondat legyen, mind a progiban mind az ábrán!}
\begin{figure}[h!]
